...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("division", sa.Enum("rookies", "int_i", "int_ii", name="division"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.Column("division", sa.Enum("rookies", "int_i", "int_ii", name="division"), nullable=False),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
